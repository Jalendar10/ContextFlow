export function meetingContext(value={}){
 ...
 const data={content:text(value.content,30000),additionalContent:text(value.additionalContent,30000),workProjects:text(value.workProjects,30000),prompt:text(value.prompt,8000),files:(value.files||[]).map(f=>({name:text(f.name,200),text:text(f.text,100000)}))};
